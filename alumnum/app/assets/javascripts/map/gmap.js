function initMap() {
        var myLatLng = {lat: @this_image_properties[:lat], lng: @this_image_properties[:lon]};
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDDeQPIbdoCnd0pz06J3ZNCT77aWbfevMA&callback=initMap">
    </script>
...
function initialize() {
  ...
  var mapOptions = {
          center: new google.maps.LatLng(@this_image_properties[:lat], @this_image_properties[:lat]),
          zoom: 14,
